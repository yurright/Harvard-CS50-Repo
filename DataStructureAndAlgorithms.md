...
- **Definition**: a structure where nodes are connected to each other, and there is a way(and only one way) to go from the root node to every other node in the structure"
